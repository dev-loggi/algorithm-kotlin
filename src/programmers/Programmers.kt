...
object Programmers {
    ...
    object Practice {
        ...
        object LevelOne {
            ...
            val calculateShortfall: Solution get() = CalculateShortfall()
            ...
            val getMiddleLetter: Solution get() = GetMiddleLetter()
        ...
        object LevelTwo {
            ...
            val discountEvent: Solution get() = DiscountEvent()
            val disGuise: Solution get() = DisGuise()
            val expectedScorecard: Solution get() = ExpectedScorecard()
            ...
            val longJump: Solution get() = LongJump()
            val makingBigNumbers: Solution get() = MakingBigNumbers()
            ...
            val quadExpressionCounting: Solution get() = QuadExpressionCounting()
            val nLcm: Solution get() = Nlcm()
            val noMoreThanTwoDifferentBits: Solution get() = NoMoreThanTwoDifferentBits()
